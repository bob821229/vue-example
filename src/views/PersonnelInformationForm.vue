<template>
    <div style="width: 100%;padding: 50px;">
        <n-data-table :columns="columns" :data="data" :pagination="pagination" @update:sorter="handleSorterChange" />
        <n-button @click="createData">
            新增
        </n-button>
    </div>
    ...
    <n-modal v-model:show="showModal1">
        ...
        <n-card style="width:80%; margin: 20px auto;" :title="modalTitle" :bordered="false" size="huge" role="dialog"
            aria-modal="true">
                ...
                <n-form ref="formRef" :rules="rules" size="large" label-placement="top">
                    <n-grid :cols="24" :x-gap="24">
                        ...
                        <n-form-item-gi :span="8">
                            ...
                            <n-select v-model:value="model.department" placeholder="進用部門"
                        ...
                        <n-form-item-gi :span="3" label="大頭照">
                            <n-upload action="https://www.mocky.io/v2/5e4bafc63100007100d8b70f"
                                :default-file-list="previewFileList" list-type="image-card" max=1
                        ...
                        <template v-for="(item, index) in model.schools" :key="index">
                            ...
                            <n-form-item-gi :span="10" label="修業起訖年月">
                                <n-date-picker v-model:value="model.schools[index].period" type="monthrange"
                                    clearable />
                                <n-button-group>
                        ...
                        <template v-for="(item, index) in model.workExperience" :key="index">
                            ...
                            <n-form-item-gi :span="8" label="服務起訖年月">
                                <n-date-picker v-model:value="model.workExperience[index].period" type="monthrange"
                                    clearable />
                                <n-button-group>
                        ...
                        <n-form-item-gi :span="14" label="語言能力">
                            <n-checkbox-group v-model:value="model.languages">
                                <n-space>
                                    <n-checkbox :checked="lang.checked" :value="lang.value"
                                        v-for="lang in languagesOptions" :key="lang.value">
                                        {{ lang.value }}
                                    </n-checkbox>
                                </n-space>
                            </n-checkbox-group>
                            ...
                            <n-space align="center">
                                ...
                                <n-input size="small" v-if="otherLanguage" v-model:value="customLanguage"
                                    placeholder="請輸入其他語言" @keyup.enter="addCustom('language')" />
                            </n-space>
                        ...
                        <n-form-item-gi :span="14" label="電腦專長">
                            <n-checkbox-group v-model:value="model.computerExpertise">
                                <n-space>
                                    <n-checkbox :value="lang.value" v-for="lang in computerExpertiseOptions"
                                        :key="lang.value">
                                        {{ lang.value }}
                                    </n-checkbox>
                                </n-space>
                            ...
                            <n-space align="center">
                                ...
                                <n-input size="small" v-if="othercomputerExpertise"
                                    v-model:value="customComputerExpertise" placeholder="請輸入其他專長"
                                    @keyup.enter="addCustom('computerExpertise')" />
                            </n-space>
                        ...
                        <n-form-item-gi :span="6" label="行動電話">
                            <n-input v-model:value="model.emergencyContact.mobile" placeholder="行動電話" show-count
                                :maxlength="10" :allow-input="onlyAllowNumber" />
                        </n-form-item-gi>
                        <n-gi :span="24">
                            <n-divider>國泰世華銀行 薪資撥入帳號 <span
                                    style="color:red;margin-left: 10px;">(請詳細填寫)</span></n-divider>
                        </n-gi>
...
const columns = [
    ...
    },
    {
        ...
        filter(value: string, row: object) {
            return row.department.includes(value)
        }
    },
    {
        title: 'Action',
...
const data = [
    ...
    },
    {
        ...
        homePhone: "033124569",
        phone: "0912345648",
        residenceAddress: "新北市淡水區中正東路38號",
        mailingAddress: "新北市淡水區中正東路38號",
        email: "abc789@gmail.com",
        specialStatus: ["原住民", "身心障礙"],
        drvingLicense: ["汽車"],
        maritalStatus: "未婚",
        schools: [
            {
                name: "台大", department: "數學",
                period: [1717171200000, 1717171200000]
            }
        ],
        workExperience: [
            {
                ...
                salary: "22000",
                leavingReason: "錢太少",
                period: [1711900800000, 1717171200000]
            }
        ],
        languages: ["國語", "台語", "泰語"],
        computerExpertise: ["Word", "Excel"],
        professionalLicense: "化學丙級",
        knowledgeAndSkills: "簡報技巧",
        emergencyContact: {
            name: "林小美",
            relationship: "母子",
            phone: "0332546985",
